...
exports.isDeepNonNullWithAllowedPaths = exports.DeepNonNullError = void 0;
 ...
 */
var DeepNonNullError = /** @class */ (function (_super) {
    __extends(DeepNonNullError, _super);
    function DeepNonNullError() {
        var params = [];
        ...
        if (Error.captureStackTrace) {
            Error.captureStackTrace(_this, DeepNonNullError);
        }
        _this.name = 'DeepNonNullError';
        return _this;
    }
    return DeepNonNullError;
}(Error));
exports.DeepNonNullError = DeepNonNullError;
